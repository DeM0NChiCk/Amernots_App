...
Если сменить пароль, затем перезайти на этот же аккаунт, то при смене темы вас снова перекинет на экран регистрации, но тема при этом сменится и выйдет Toast о смене пароля.
Предположительно связано с изменением конфигурации.
